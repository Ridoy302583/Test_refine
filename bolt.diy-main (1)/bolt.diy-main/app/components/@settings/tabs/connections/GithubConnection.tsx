      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-bolt-elements-textPrimary">Github Connection</h3>
        ...
        <div className="flex flex-col gap-4">
          {!user ? (
            <>
              ...
              <div className="flex gap-2 w-full mt-2 text-sm text-bolt-elements-textSecondary">
                <a
            ...
            <div className='w-full'>
              {user && stats && (
                <div className="border-t border-bolt-elements-borderColor dark:border-bolt-elements-borderColor pt-6">
