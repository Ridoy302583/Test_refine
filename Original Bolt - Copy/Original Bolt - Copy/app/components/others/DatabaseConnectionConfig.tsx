...
export function DatabaseConnectionConfig({ openFirebaseConnectionDialog, onClose }: FirebaseConnectionDialogProps) {
                            ...
                            <div>
                                <div className="p-4 grid grid-cols-1 gap-2 sm:gap-3 md:gap-4 relative">
                                    ...
                                    >
                                        ...
                                        <div className={`absolute top-2 sm:top-3 md:top-4 right-2 sm:right-3 md:right-4 w-1.5 sm:w-2 h-1.5 sm:h-2 rounded-full ${FirebaseConnectionOk ? 'bg-green-500' : 'bg-purple-500 dark:bg-purple-400 animate-pulse'}`} />
